...
function realEstates() {
	...
	var backStretchImageAlt = $(".backstretch img").attr("alt", "Image description coming soon");
	var backStretchImageHeight = $(".backstretch img").attr("height", "264");
	var backStretchImageWidth = $(".backstretch img").attr("width", "400");
