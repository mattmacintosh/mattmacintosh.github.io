...
$page_title = 'Abstract 8';
$body_class = 'featured cmyk cmyk-8';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="abstract-CMYK-menu" role="navigation">
				<ul class="block">
					...
					<li class="cmyk-8 active"><a href="/cmyk/cmyk-eight/">Abstract 8</a></li>
				</ul>
			</nav>
		</div><!-- /.section-access -->';
$page_content = '<p class="thumbnail"><img alt="MacOS, Abstract CMYK 8 Photograph" src="http://mattmacintosh.com/images/cmyk/tb/Matt-Macintosh_CMYK-8_tb.jpg" /></p>';
