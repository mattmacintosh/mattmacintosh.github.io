...
$page_title = 'Abstract 3';
$body_class = 'featured cmyk cmyk-3';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="abstract-CMYK-menu" role="navigation">
				<ul class="block">
					...
					<li class="cmyk-3 active"><a href="/cmyk/cmyk-three/">Abstract 3</a></li>
...
$page_content = '<p class="thumbnail"><img alt="MacOS, Abstract CMYK 3 Photograph" src="http://mattmacintosh.com/images/cmyk/tb/Matt-Macintosh_CMYK-3_tb.jpg" /></p>';
