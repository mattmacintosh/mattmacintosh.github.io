...
$page_title = 'Abstract 7';
$body_class = 'featured cmyk cmyk-7';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="abstract-CMYK-menu" role="navigation">
				<ul class="block">
					...
					<li class="cmyk-7 active"><a href="/cmyk/cmyk-seven/">Abstract 7</a></li>
					<li class="cmyk-8"><a href="/cmyk/cmyk-eight/">Abstract 8</a></li>
				</ul>
			</nav>
		</div><!-- /.section-access -->';
$page_content = '<p class="thumbnail"><img alt="MacOS, Abstract CMYK 7 Photograph" src="http://mattmacintosh.com/images/cmyk/tb/Matt-Macintosh_CMYK-7_tb.jpg" /></p>';
