...
$page_title = 'Abstract 4';
$body_class = 'featured cmyk cmyk-4';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="abstract-CMYK-menu" role="navigation">
				<ul class="block">
					...
					<li class="cmyk-4 active"><a href="/cmyk/cmyk-four/">Abstract 4</a></li>
...
$page_content = '<p class="thumbnail"><img alt="MacOS, Abstract CMYK 4 Photograph" src="http://mattmacintosh.com/images/cmyk/tb/Matt-Macintosh_CMYK-4_tb.jpg" /></p>';
