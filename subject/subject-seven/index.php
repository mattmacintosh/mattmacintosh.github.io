...
$page_title = 'Subject 7';
$body_class = 'subject sub-7';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="subject-menu" role="navigation">
				<ul class="block">
					...
					<li class="sub-7 active"><a href="/subject/subject-seven/">Subject 7</a></li>
...
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/subject/fl/Matt-Macintosh_Subject-7_fl.jpg"><img alt="Subject 3 Photograph" src="http://mattmacintosh.com/images/subject/tb/Matt-Macintosh_Subject-7_tb.jpg" /></a></p>';
