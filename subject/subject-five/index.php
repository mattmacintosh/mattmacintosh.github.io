...
$page_title = 'Subject 5';
$body_class = 'featured subject sub-5';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="subject-menu" role="navigation">
				<ul class="block">
					...
					<li class="sub-5 active"><a href="/subject/subject-five/">Subject 5</a></li>
...
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/subject/fl/Matt-Macintosh_Subject-5_fl.jpg"><img alt="Subject 3 Photograph" src="http://mattmacintosh.com/images/subject/tb/Matt-Macintosh_Subject-5_tb.jpg" /></a></p>';
