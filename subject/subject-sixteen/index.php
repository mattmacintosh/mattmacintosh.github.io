...
$page_title = 'Subject 16';
$body_class = 'featured subject sub-16';
...
$specifications = '<aside aria-label="piece-specifications" class="piece-meta">
			...
			<ul class="block">
				...
				<li><span class="assisstive-text">Measurements: </span>33 x 26in (84 x 66cm)</li>
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="subject-menu" role="navigation">
				<ul class="block">
					...
					<li class="sub-16 active"><a href="/subject/subject-sixteen/">Subject 16</a></li>
...
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/subject/fl/Matt-Macintosh_Subject-16_fl.jpg"><img alt="Subject 16 Photograph" src="http://mattmacintosh.com/images/subject/tb/Matt-Macintosh_Subject-16_tb.jpg" /></a></p>';
