...
$page_title = 'Subject 18';
$body_class = 'featured subject sub-18';
...
$specifications = '<aside aria-label="piece-specifications" class="piece-meta">
			...
			<ul class="block">
				...
				<li><span class="assisstive-text">Measurements: </span>44 x 36in (112 x 91cm)</li>
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="subject-menu" role="navigation">
				<ul class="block">
					...
					<li class="sub-18 active"><a href="/subject/subject-eighteen/">Subject 18</a></li>
...
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/subject/fl/Matt-Macintosh_Subject-18_fl.jpg"><img alt="Subject 18 Photograph" src="http://mattmacintosh.com/images/subject/tb/Matt-Macintosh_Subject-18_tb.jpg" /></a></p>';
