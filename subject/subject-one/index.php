...
$page_title = 'Subject 1';
$body_class = 'featured subject sub-1';
...
$specifications = '<aside aria-label="piece-specifications" class="piece-meta">
			...
			<ul class="block">
				...
				<li><span class="assisstive-text">Measurements: </span>41 x 44in (104 x 112cm)</li>
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="subject-menu" role="navigation">
				<ul class="block">
					<li class="sub-1 active"><a href="/subject/subject-one/">Subject 1</a></li>
...
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/subject/fl/Matt-Macintosh_Subject-1_fl.jpg"><img alt="Subject 1 Photograph" src="http://mattmacintosh.com/images/subject/tb/Matt-Macintosh_Subject-1_tb.jpg" /></a></p>';
