...
$page_title = 'Subject 1, 5, 12 Installation';
$body_class = 'subject sub-ins-4';
$main_nav = '<nav aria-label="main-menu" role="navigation" id="main-access">
				<ul class="block">
					<li class="sub active"><a href="/subject/subject-two/">Subject</a></li>
...
$specifications = '<aside aria-label="piece-specifications" class="piece-meta">
			...
			<ul class="block">
				<li><span class="assisstive-text">Date of show: </span>2012</li>
				<li><span class="assisstive-text">Location: </span>University of Toronto Art Centre</li>
				<li><span class="assisstive-text">Venue: </span>North Gallery, Looking Northwest</li>
			</ul>
		</aside>';
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="subject-menu" role="navigation">
				<ul class="block">
					...
					<li class="sub-ins-4 active"><a href="/subject/install-four/">Subject 1, 5, 12 Installation</a></li>
...
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/subject/fl/Matt-Macintosh_Install-4-North_fl.jpg"><img alt="Subject 13, 14 Installation" src="http://mattmacintosh.com/images/subject/tb/Matt-Macintosh_Install-4-North_tb.jpg" /></a></p>';
