...
$page_title = 'Subject 12';
$body_class = 'featured subject sub-12';
...
$specifications = '<aside aria-label="piece-specifications" class="piece-meta">
			...
			<ul class="block">
				...
				<li><span class="assisstive-text">Measurements: </span>44 x 66in (112 x 168cm)</li>
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="subject-menu" role="navigation">
				<ul class="block">
					...
					<li class="sub-12 active"><a href="/subject/subject-twelve/">Subject 12</a></li>
...
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/subject/fl/Matt-Macintosh_Subject-12_fl.jpg"><img alt="Subject 3 Photograph" src="http://mattmacintosh.com/images/subject/tb/Matt-Macintosh_Subject-12_tb.jpg" /></a></p>';
