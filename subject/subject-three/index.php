...
$page_title = 'Subject 3';
$body_class = 'featured subject sub-3';
...
$specifications = '<aside aria-label="piece-specifications" class="piece-meta">
			...
			<ul class="block">
				...
				<li><span class="assisstive-text">Measurements: </span>48 x 44in (122 x 112cm)</li>
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="subject-menu" role="navigation">
				<ul class="block">
					...
					<li class="sub-3 active"><a href="/subject/subject-three/">Subject 3</a></li>
...
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/subject/fl/Matt-Macintosh_Subject-3_fl.jpg"><img alt="Subject 3 Photograph" src="http://mattmacintosh.com/images/subject/tb/Matt-Macintosh_Subject-3_tb.jpg" /></a></p>';
