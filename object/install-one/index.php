...
$page_title = 'Object 1 installation';
$body_class = 'featured object obj-ins-1';
...
$specifications = '<aside aria-label="piece-specifications" class="piece-meta">
			...
			<ul class="block">
				...
				<li><span class="assisstive-text">Venue: </span>Barrel Vault, Looking West</li>
			</ul>
		</aside>';
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="object-menu" role="navigation">
				<ul class="block">
					...
					<li class="obj-3"><a href="/object/object-three/">Object 3</a></li>
					<li class="obj-6"><a href="/object/object-six/">Object 6</a></li>
					<li class="obj-8"><a href="/object/object-eight/">Object 8</a></li>
					<li class="obj-ins-1 active"><a href="/object/install-one/">Object 1 Installation</a></li>
					<li class="obj-ins-2"><a href="/object/install-two/">Subject 3, 13, Object 3 Installation</a></li>
				</ul>
			</nav>
		</div><!-- /.section-access -->';
$page_content = '<p class="thumbnail"><a href="http://mattmacintosh.com/images/object/fl/Matt-Macintosh_Install-1-Mid_fl.jpg"><img alt="Object 1 Installation Photograph" src="http://mattmacintosh.com/images/object/tb/Matt-Macintosh_Install-1-Mid_tb.jpg" /></a></p>';
