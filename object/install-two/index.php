...
$page_title = 'Subject 3, 13, Object 3 Installation';
$body_class = 'featured object obj-ins-2';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="object-menu" role="navigation">
				<ul class="block">
					...
					<li class="obj-ins-2 active"><a href="/object/install-two/">Subject 3, 13, Object 3 Installation</a></li>
				</ul>
			</nav>
		</div><!-- /.section-access -->';
