...
$page_title = 'Tao Te Ching';
$body_class = 'featured im tao-te';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="tao-te active"><a href="/im/tao-te-ching/">Tao Te Ching</a></li>
					<li class="shads"><a href="/im/upanishads/">Upanishads</a></li>
				</ul>
			</nav>
		</div><!-- /.section-access -->';
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Tao-Te.jpg" alt="Tao Te Ching Photograph" /></p>';
