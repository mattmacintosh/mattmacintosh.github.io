...
$page_title = 'New Testament';
$body_class = 'featured im new-test';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="new-test active"><a href="/im/new-testament/">New Testament</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-New-Test.jpg" alt="New Testament Photograph" /></p>';
