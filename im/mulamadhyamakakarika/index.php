...
$page_title = 'Mūlamadhyamakakārikā';
$body_class = 'featured im mula';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="mula active"><a href="/im/mulamadhyamakakarika/">Mūlamadhyamakakārikā</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Karika.jpg" alt="Mulamadhyamakakarika Photograph" /></p>';
