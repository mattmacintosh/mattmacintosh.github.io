...
$page_title = 'Philosophical Investigations';
$body_class = 'featured im invest';
...
$specifications = '<aside aria-label="piece-specifications" class="piece-meta">
			<p class="block">Complete foundational texts re-formatted as monochromes and printed on cellulose. Prints were buried underground on the last day of fall 2012 (Dec 20), and will be exhumed on the last day of spring 2014 (June 20).</p>
			<ul class="block">
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					<li class="al-q"><a href="/im/al-qur-an/">Al Qur\'an</a></li>
					...
					<li class="invest active"><a href="/im/philosophical-investigations/">Philosophical Investigations</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Investigations.jpg" alt="Philosophical Investigations Photograph" /></p>';
