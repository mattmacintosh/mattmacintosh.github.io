...
$page_title = 'Synthesis of Yoga';
$body_class = 'featured im yoga';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="yoga active"><a href="/im/synthesis-of-yoga/">Synthesis of Yoga</a></li>
					<li class="tao-te"><a href="/im/tao-te-ching/">Tao Te Ching</a></li>
					<li class="shads"><a href="/im/upanishads/">Upanishads</a></li>
				</ul>
			</nav>
		</div><!-- /.section-access -->';
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Yoga.jpg" alt="Synthesis of Yoga Photograph" /></p>';
