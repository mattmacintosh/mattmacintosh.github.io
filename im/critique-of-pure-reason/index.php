...
$page_title = 'Critique of Pure Reason';
$body_class = 'featured im critique';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="critique active"><a href="/im/critique-of-pure-reason/">Critique of Pure Reason</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Critique.jpg" alt="Critique of Pure Reason Photograph" /></p>';
