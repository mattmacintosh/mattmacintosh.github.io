...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="gita active"><a href="/im/bhagavad-gita/">Bhagavad Gita</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Bhagavad-Gita.jpg" alt="Bhagavad Gita Photograph" /></p>';
