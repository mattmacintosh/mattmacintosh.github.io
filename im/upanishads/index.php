...
$page_title = 'Upanishads';
$body_class = 'featured im shads';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="shads active"><a href="/im/upanishads/">Upanishads</a></li>
				</ul>
			</nav>
		</div><!-- /.section-access -->';
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Upanishads.jpg" alt="Upanishads Photograph" /></p>';
