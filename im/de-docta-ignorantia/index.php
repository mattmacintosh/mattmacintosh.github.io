...
$page_title = 'De Docta Ignorantia';
$body_class = 'featured im docta';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="docta active"><a href="/im/de-docta-ignorantia/">De Docta Ignorantia</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Docta.jpg" alt="De Docta Ignorantia Photograph" /></p>';
