...
$page_title = 'Old Testament';
$body_class = 'featured im old-test';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="old-test active"><a href="/im/old-testament/">Old Testament</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Old-Test.jpg" alt="Old Testament Photograph" /></p>';
