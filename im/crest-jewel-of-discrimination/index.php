...
$page_title = 'Crest Jewel of Discrimination';
$body_class = 'featured im crest';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="crest active"><a href="/im/crest-jewel-of-discrimination/">Crest Jewel of Discrimination</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Crest-Jewel.jpg" alt="Crest Jewel of Discrimination Photograph" /></p>';
