...
$page_title = 'Hsin Hsin Ming';
$body_class = 'featured im ming';
...
$section_access = '<div role="complementary" class="section-access">
			<nav aria-label="illuminated-manuscripts-menu" role="navigation">
				<ul class="block">
					...
					<li class="ming active"><a href="/im/hsin-hsin-ming/">Hsin Hsin Ming</a></li>
...
$page_content = '<p class="thumbnail"><img src="http://mattmacintosh.com/images/im/Matt-Macintosh-th-Ming.jpg" alt="Hsin Hsin Ming Photograph" /></p>';
